...
export default function LoginScreen({ onLogin, expiredMessage }) {
  // Método de autenticación: 'email' | 'phone'
  const [authMethod, setAuthMethod] = useState("email");

  // Modo: 'login' | 'signup' | 'code'  
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        ...
        >
          {/* ──────────────────────────────────────────── */}
          {/* SELECTOR DE MÉTODO (Email vs Teléfono) */}
          {/* ──────────────────────────────────────────── */}
          {mode !== "code" && (
            <div className="flex gap-2 mb-6">
              ...
              >
                <Mail size={18} className={authMethod === "email" ? "text-[#22c55e]" : "text-[#737373]"} />
                <span className={authMethod === "email" ? "text-white" : "text-[#a3a3a3]"}>
                  Email
                </span>
              </button>
              ...
              <button
                ...
                className="flex-1 rounded-lg px-4 py-3 font-medium text-sm
                           transition-all duration-200 flex items-center justify-center gap-2"
              >
                <Smartphone size={18} className={authMethod === "phone" ? "text-[#22c55e]" : "text-[#737373]"} />
                <span className={authMethod === "phone" ? "text-white" : "text-[#a3a3a3]"}>
                  Teléfono
                </span>
              </button>
            </div>
          ...
          {authMethod === "phone" && mode === "login" && (
            <PhoneLoginForm onSuccess={onLogin} />
          )}
